...
namespace Laba_4_Inheritance
{
    ...
    */
    ...
    public class Vehicle
    {
        ...
        public int number_of_wheels = 0;
        public  virtual String GetInfo()
        {
            var str = String.Format("\nКоличество колёс: {0}", this.number_of_wheels);
    ...
    public class Bike : Vehicle
    {
        ...
        public static Bike Generate()
        {
            ...
            return new Bike
            {
                ...
                number_of_wheels = /*2 + rnd.Next() % 9*/(2 + rnd.Next() % 2 )
            };
        }
    }
    ...
    { 
        ...
        public static Car Generate()
        {
            ...
            return new Car
            {
                ...
                number_of_wheels = /*2 + rnd.Next() % 9*/(1 + rnd.Next() % 4) * 2
            };
        }
    }
    ...
    { 
        ...
        public static Plane Generate()
        {
            ...
            return new Plane
            {
                ...
                number_of_wheels = /*2 + rnd.Next() % 9*/(1 + rnd.Next() % 5) * 2
            };
        }
    }
}